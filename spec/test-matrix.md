...
| TC-032 | Enforce one comment-safe scoped ix-flow package identity, manual-only hosted trigger, alias rejection, and exact released runtime version | Integration | P0 | NFR-003-AC-5 | ✅ implemented |
