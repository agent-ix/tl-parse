...
| FR-005-AC-4 | Evidence schemas, manifest, envelope, checksums, explicit retractions, and human-authority boundary are machine-checkable; history checks are relative to the presented Git history. | Test (TC-022) |
