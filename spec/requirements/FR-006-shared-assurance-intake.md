...
|---|---|---|
| FR-006-AC-1 | The adopted component versions are classified by the exact native Engineering Assurance compatibility CLI; its human-acceptance gate is honored, no matrix rule is restated locally, and no component resolves from the internal mirror. | Test (TC-022) |
