...
scope: "tl-parse#25 implementation at cc543ea391625d173b3cbb02bfafbf7b5615f784"
review_set: subset
---
...
- **Profile:** `AP-001` (`spec/assurance/AP-001.md`), version 0.2, status
  ...
  gap analysis.
- **Baseline:** `cc543ea391625d173b3cbb02bfafbf7b5615f784` on PR #34.
...
- `make ci` reached every Rust, corpus, fuzz, dependency and assurance gate;
  after FND-5403 the resumed exact-head `make spec msrv rustdoc assurance`
  completed successfully at `cc543ea`.
