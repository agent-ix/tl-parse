...
| FND-3216 | high | **FIXED after independent review of `89127ce`:** shell escaping was processed before GitHub-expression recognition, so `\${{ ... }}` could reach GitHub evaluation while remaining green locally. The scanner now recognizes `${{ ... }}` before shell quote or escape handling, with separate unquoted-escaped and double-quoted-escaped mutations. | NFR-003-AC-5, TC-032, tests/shared_assurance.rs, tl-parse#30 review |
