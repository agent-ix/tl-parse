...
| FND-3212 | medium | **FIXED after independent review of `085783e`:** a leading shell redirection occupied the scanner's command position and hid a path-qualified npm alternate. Command discovery now skips attached or separate leading redirections and TC-032 covers the reviewer mutation. | NFR-003-AC-5, TC-032, tests/shared_assurance.rs, tl-parse#28 review |
...
| FND-3214 | high | **FIXED during cross-lane remediation after merge of #28:** `2>&1` was split at `&` before command discovery could recognize the declared `>&` redirection. The tokenizer now retains fd-duplication operators and TC-032 names an alternate after that prefix. | NFR-003-AC-5, TC-032, tests/shared_assurance.rs, tl-rewrite#34 review |
