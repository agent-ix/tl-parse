...
Strict coverage maps all 62 rows to executable or retained inspection
...
| FND-307 | medium | Local Rust coverage is 88.20% of lines and 84.62% of functions; the CLI binary is lowest at 82.69% of lines and 50.00% of functions. Reachable CLI/error paths and defensive-branch classification remain follow-up work in issue #8, not a claim of full testing. | FR-003, FR-005, TC-021 |
| FND-308 | medium | The policy suite covers individual qualification behaviors, but exact collector failure injection and cleanup boundaries need a disposable-worktree integration suite. Issue #7 tracks the residual without weakening the current fail-closed collector. | NFR-003, TC-023, TC-025 |
| FND-309 | low | The exact local tool lock is intentionally environment-specific and is not a hosted-runner profile. Issue #9 tracks a portable versioned design before hosted CI is ever reintroduced; automatic CI remains disabled. | NFR-002, NFR-003 |
